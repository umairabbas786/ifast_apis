...
Java_com_electrodragon_i_1fast_1api_provider_ElectroLibAccessProvider_getMasterKey(JNIEnv* env, jobject _j) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_electrodragon_i_1fast_1api_provider_ElectroLibAccessProvider_getSecretKey(JNIEnv* env, jobject _j) {
    std::string s = "19XNGLNVWP8UMHT9JNZ0OQXQPJNM6IF7JBJGEXB6Y82RG6YW4R6GPZHZPXPB7Q4OT873A4";
    return env->NewStringUTF(s.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_electrodragon_i_1fast_1api_provider_ElectroLibAccessProvider_getServerBaseUrl(JNIEnv* env, jobject _j) {
    std::string s = "https://api.i_fast_api.com/";
    return env->NewStringUTF(s.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_electrodragon_i_1fast_1api_provider_ElectroLibAccessProvider_getServerApiKey(JNIEnv* env, jobject _j) {
