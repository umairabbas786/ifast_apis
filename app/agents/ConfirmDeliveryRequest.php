    ...
    protected function onDevise() {
        ...
        $this->resSendOK([
            'confirm_delivery_success'=>[
                ...
                ConfirmDeliveryTableSchema::NUMBER_PLATE => $this->createLinkForDeliveryProofImage($Delivery->getNumberPlate()),
                ConfirmDeliveryTableSchema::FACE => $this->createLinkForDeliveryProofImage($Delivery->getFace()),
                ConfirmDeliveryTableSchema::BEFORE_ITEMS => $this->createLinkForDeliveryProofImage($Delivery->getBeforeItems()),
                ConfirmDeliveryTableSchema::AFTER_ITEMS => $this->createLinkForDeliveryProofImage($Delivery->getAfterItems()),
